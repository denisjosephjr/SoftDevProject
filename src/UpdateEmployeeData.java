...
public class UpdateEmployeeData {
    ...
    private int searchByEmpId() {
        ...
        String query = "SELECT empid, Fname, Lname, email FROM employee WHERE empid = ?";
    ...
    private int searchByLastName() {
        ...
        String query = "SELECT empid, Fname, Lname, email FROM employee WHERE Lname = ?";
    ...
    private int searchByEmail() {
        ...
        String query = "SELECT empid, Fname, Lname, email FROM employee WHERE email = ?";
    ...
    private void updateFname(int empId) {
        ...
        runUpdate("UPDATE employee SET Fname = ? WHERE empid = ?", fname, empId);
    }

    private void updateLname(int empId) {
        System.out.print("Enter new Last Name: ");
        String lname = scanner.nextLine();
        runUpdate("UPDATE employee SET Lname = ? WHERE empid = ?", lname, empId);
    }

    private void updateEmail(int empId) {
        System.out.print("Enter new Email: ");
        String email = scanner.nextLine();
        runUpdate("UPDATE employee SET email = ? WHERE empid = ?", email, empId);
    }

    private void updateHireDate(int empId) {
        System.out.print("Enter new Hire Date (YYYY-MM-DD): ");
        String date = scanner.nextLine();
        runUpdate("UPDATE employee SET HireDate = ? WHERE empid = ?", date, empId);
    }

    private void updateSalary(int empId) {
        System.out.print("Enter new Salary: ");
        String salary = scanner.nextLine();
        runUpdate("UPDATE employee SET Salary = ? WHERE empid = ?", salary, empId);
    }
